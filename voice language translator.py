# here import the library used in this Program
from tkinter import *
...
frame.place(x=0,y=0)
# Language dictonary for the code of the language
LANGUAGES = {
'afrikaans': 'af','albanian': 'sq','amharic': 'am', 'arabic': 'ar', 'armenian': 'hy','azerbaijani': 'az',
'basque': 'eu', 'belarusian': 'be', 'bengali': 'bn','bhojpuri':'bho','bosnian': 'bs','bulgarian': 'bg', 'catalan': 'ca', 'cebuano': 'ceb', 
...
#for take input of  speech from the user 
def play1():
...
# for convert text into the voice
def Text_To_Voice(speech,lancode1):
        mytext=speech
        language=lancode1
        myvoice=gTTS(text=mytext,lang=language,slow=False)
        myvoice.save("surya.mp3")
        playsound("surya.mp3")
        os.remove("surya.mp3")
